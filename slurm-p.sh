...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_gpus=1 \
	--layer=-2 \
	--temperature=1.0 > output/benchmark_sampling-p8-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_gpus=1 \
	--layer=-2 \
	--temperature=1.0 > output/benchmark_sampling-p16-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_gpus=1 \
	--layer=-2 \
	--temperature=1.0 > output/benchmark_sampling-p32-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_gpus=1 \
	--layer=-2 \
	--temperature=1.0 > output/benchmark_sampling-p64-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_gpus=1 \
	--layer=-2 \
	--temperature=1.0 > output/benchmark_sampling-p128-s8.log 2>&1