...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_generation=8 \
	--max_steps=8 \
	--num_gpus=1 > output/benchmark_sampling-p8-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_generation=16 \
	--max_steps=8 \
	--num_gpus=1 > output/benchmark_sampling-p16-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_generation=32 \
	--max_steps=8 \
	--num_gpus=1 > output/benchmark_sampling-p32-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_generation=64 \
	--max_steps=8 \
	--num_gpus=1 > output/benchmark_sampling-p64-s8.log 2>&1
...
CUDA_VISIBLE_DEVICES=0 python ./src/x_r1/benchmark_MVOT_latent.py \
	...
	--num_generation=128 \
	--max_steps=8 \
	--num_gpus=1 > output/benchmark_sampling-p128-s8.log 2>&1