...
if __name__ == "__main__":
    ...
    for _ in range(args.num_of_questions):
        ...
        values = [random.randint(-2, 2) for _ in range(num_of_var)]
        values = dict(zip(variables, values))

        prompt = '''Given the following variables and operations, what is the final value of each variable:\n'''
    ...
    # Save the dataset
    with open("src/fol_r1/test/gsc/GSC.json", "w") as f:
