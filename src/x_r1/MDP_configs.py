...
class GRPOConfig(trl.GRPOConfig):
    ...
    extra_generations: int = field(
        default=0,
        metadata={ "help": "Number of extra generation during rollout step."},
    )
    delta: float = field(
        default=0.5,
        metadata={"help": "Delta value for updating the MDP tree. This is used to control the bias-variance tradeoff"},
    )
